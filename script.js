...
function checkoutWhatsapp() {
  ...
  const delivery = document.querySelector('input[name="delivery"]:checked')?.value || "Por confirmar";
  const payment = document.querySelector('input[name="payment"]:checked')?.value || "Por confirmar";
